...
_VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST = _descriptor.Descriptor(
  name='VolumeMaximumSnapshotCountSetRequest',
  full_name='ptypes.VolumeMaximumSnapshotCountSetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='count', full_name='ptypes.VolumeMaximumSnapshotCountSetRequest.count', index=0,
...
_VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST = _descriptor.Descriptor(
  name='VolumeMaximumTotalSnapshotSizeSetRequest',
  full_name='ptypes.VolumeMaximumTotalSnapshotSizeSetRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='ptypes.VolumeMaximumTotalSnapshotSizeSetRequest.size', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['VolumeMaximumSnapshotCountSetRequest'] = _VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST
DESCRIPTOR.message_types_by_name['VolumeMaximumTotalSnapshotSizeSetRequest'] = _VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST
...
VolumeMaximumSnapshotCountSetRequest = _reflection.GeneratedProtocolMessageType('VolumeMaximumSnapshotCountSetRequest', (_message.Message,), {
  'DESCRIPTOR' : _VOLUMEMAXIMUMSNAPSHOTCOUNTSETREQUEST,
  '__module__' : 'controller_pb2'
  # @@protoc_insertion_point(class_scope:ptypes.VolumeMaximumSnapshotCountSetRequest)
  })
_sym_db.RegisterMessage(VolumeMaximumSnapshotCountSetRequest)

VolumeMaximumTotalSnapshotSizeSetRequest = _reflection.GeneratedProtocolMessageType('VolumeMaximumTotalSnapshotSizeSetRequest', (_message.Message,), {
  'DESCRIPTOR' : _VOLUMEMAXIMUMTOTALSNAPSHOTSIZESETREQUEST,
  '__module__' : 'controller_pb2'
  # @@protoc_insertion_point(class_scope:ptypes.VolumeMaximumTotalSnapshotSizeSetRequest)
  })
_sym_db.RegisterMessage(VolumeMaximumTotalSnapshotSizeSetRequest)
...
_CONTROLLERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='VolumeMaximumSnapshotCountSet',
    full_name='ptypes.ControllerService.VolumeMaximumSnapshotCountSet',
    index=9,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='VolumeMaximumTotalSnapshotSizeSet',
    full_name='ptypes.ControllerService.VolumeMaximumTotalSnapshotSizeSet',
    index=10,
    containing_service=None,
